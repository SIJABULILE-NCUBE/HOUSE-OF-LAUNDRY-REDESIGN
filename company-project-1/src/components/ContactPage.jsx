      ...
      <div className="max-w-[800px] mx-auto px-7">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="glass-panel rounded-[20px] p-6">
            <h3 className="font-display font-semibold text-base mb-4">Quick contact</h3>
          ...
          {/* email placeholder */}
          <div className="glass-panel rounded-[20px] p-6">
            <h3 className="font-display font-semibold text-base mb-4">Send a message</h3>
            <div className="mb-3">
            ...
            <p className="text-[11px] text-[#9AA6AE] italic mt-3">
              No public email is currently listed. Confirm a real inbox with the owner before this form goes live.
            </p>
          </div>
        </div>
      </div>
