...
**Household services**
- Laundry (wash, dry, fold and iron) — charged per kilogram
...
## 5. What My Redesign Does

My redesign keeps everything that works about the business and presents it in a modern, professional way. Key features:

**Design & branding**
- A premium silver, charcoal and glass aesthetic that feels classy and trustworthy
- The business's real cyan brand colour retained as a refined accent
- A recreation of their wave/hanger logo (ready to be swapped for their real logo file)
- Their "We do it with pride" motto kept front and centre
- Full light mode and dark mode, with text colours tuned for readability in both
...
- An **order basket** where customers can compile a laundry request and send it straight to the shop via WhatsApp or email — no payment processing, just a modern way to request service
- A floating WhatsApp button on every page for instant contact
- A **customer reviews** section with a like button on each review
- A **Laundry Tip of the Day** that changes daily, giving visitors a reason to return
- Subtle laundry-themed animations (rising steam, floating bubbles, swaying pegs) to bring the design to life
...
The goal of the project was to demonstrate my ability to research a real business, understand its needs, and design and build a professional, modern, responsive website that genuinely serves those needs.
...
I'm grateful to the owner for engaging with me, granting permission, and sharing real photographs. It made this project far more meaningful than a purely hypothetical exercise, and I hope the result does justice to a business that clearly takes pride in its work.