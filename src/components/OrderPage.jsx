...
export default function OrderPage() {
  ...
  function buildMessage() {
    ...
    if (note) msg += `\nNote: ${note}\n`;
    msg += `\nPlease confirm availability and collection/delivery. Thank you!`;
      ...
      <div className="max-w-[800px] mx-auto px-7">
              ...
              <div className="flex flex-wrap gap-2">
                {items.map((item) => (
                  <button
                    ...
                    className="text-[12px] font-medium px-3 py-1.5 rounded-full border border-brand-silver-300 text-[#48555D] hover:bg-brand-cyan hover:border-brand-cyan hover:text-white transition-all"
                  >
        ...
        {cart.length > 0 ? (
          <div className="glass-panel rounded-[20px] p-6 mb-6">
            <div className="flex justify-between items-center mb-4">
              <h3 className="font-display font-semibold text-base">Your items</h3>
              ...
              <div key={item.id} className="flex items-center justify-between py-3 border-b border-brand-silver/60 last:border-0">
                ...
                <div className="flex items-center gap-3">
                  <button
                    ...
                    className="w-7 h-7 rounded-full border border-brand-silver-300 text-sm flex items-center justify-center hover:bg-brand-cyan hover:text-white hover:border-brand-cyan transition-all"
                  >
                    −
                  </button>
        ...
        {cart.length > 0 && (
          <div className="glass-panel rounded-[20px] p-6">
            ...
            <div className="grid md:grid-cols-2 gap-4 mb-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-white/50 border border-brand-silver-300 rounded-lg px-3.5 py-2.5 text-sm"
                />
              </div>
              <div>
            ...
            <div className="mb-4">
              <label className="text-[12.5px] font-semibold block mb-1.5">Notes (optional)</label>
              <textarea
                value={note}
            ...
            <div className="flex gap-3 flex-wrap">
              ...
              <button
                onClick={handleEmail}
                className="border border-brand-silver-300 px-6 py-3 rounded-full font-semibold text-[13px] text-[#48555D] hover:bg-brand-cyan hover:border-brand-cyan hover:text-white transition-all"
              >
                Send via Email
              </button>
            </div>
